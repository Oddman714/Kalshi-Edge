...
function loadState(){
  ...
  fetch(url,{cache:'no-store'})
    ...
    .catch(function(e){
      ...
      if(!_loaded){if(cb){cb.style.display='block';cb.style.background='rgba(245,166,35,0.95)';cb.style.color='#000';cb.style.padding='10px 16px';cb.style.textAlign='center';cb.style.fontWeight='600';cb.style.fontSize='12px';cb.textContent='Connecting ('+_retries+'): '+e.message;}}

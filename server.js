...
// =============================================================================
// KalshiBot v17.0 — 9/10 FLYWHEEL: ALL SLOTS ALWAYS FILLED
// =============================================================================
...
async function executeTrade(sig) {
  ...
  const is15MinMomentum = /kxsol15m|kxxrp15m|kxeth15m|kxbtc15m/i.test(sig.ticker) && isFastPath;
...
async function startBot() {
  ...
  _botStarted = true;
  S.isRunning = true;
  log('[M] KalshiBot v17.0 started -- running pre-flight sync...');
...
server.listen(CFG.port, () => {
  log(`KalshiBot v17.0 listening on port ${CFG.port}`);

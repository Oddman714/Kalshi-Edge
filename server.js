  ...
  try {
    const r = await req('https://api.anthropic.com/v1/messages', {
      ...
      body: {
        ...
        max_tokens: 3000,
        system: 'You are an aggressive JSON-only trading signal generator. ONE goal: double portfolio to $500K as fast as safely possible. You have open position slots that NEED filling. Use ALL 10 web searches. Search every promising market. If a market has net edge >= 5% after fees, SIGNAL IT. Do not be timid. Empty slots = missed compounding = failed mission. Output ONLY valid JSON starting with { and ending with }. No markdown, no preamble.',

...
async function scan() {
  ...
  try {
    ...
    // Use $2 — bot should keep trading as long as there's any cash at all.
    // Open positions ($22+) will resolve and refill cash soon.
    const FLOOR = 2.00;
...
server.listen(CFG.port, () => {
  log(`KalshiBot v10.3 listening on port ${CFG.port}`);

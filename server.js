...
async function runCryptoFastPath(topMarkets) {
  ...
  for (const m of cryptoMarkets) {
    ...
    if (isUpDownTargetMkt) {
      ...
      // This is the core 60%+ win rate guarantee for Up/Down markets
      ...
      // Use market probability directly as confidence — it IS the edge
      const udConf     = Math.min(0.97, betProb + 0.01); // tiny bonus for being systematic
